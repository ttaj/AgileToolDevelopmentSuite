namespace AgileDevelopmentToolsSuite
{
  partial class MainMenuForm
  {
    ...
    private void InitializeComponent()
    {
			...
			this.loggedInTextBox.TextChanged += new System.EventHandler(this.loggedInTextBox_TextChanged);
			// 
			// tabControl1
			// 
			...
			this.createSuggestionPanel.Controls.Add(this.clearSuggestionButton);
			...
			this.suggestionDescLabel.Location = new System.Drawing.Point(2, 59);
